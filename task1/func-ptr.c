...
{
	//TODO: IMPLEMENT ME!
  Process* processThis = (Process*) this;
  Process* processThat = (Process*) that;
  
  if (processThis->priority > processThat->priority){
    return -1;
  }else if (processThis->priority < processThat->priority){
    return 1;
  }else if (processThis->arrival_time > processThat->arrival_time){
    return 1;
  }
